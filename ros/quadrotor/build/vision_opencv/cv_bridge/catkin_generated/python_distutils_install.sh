...
echo_and_run cd "/home/pat/drone/senior_project/ros/quadrotor/src/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/pat/drone/senior_project/ros/quadrotor/src/vision_opencv/cv_bridge/setup.py" \
    egg_info --egg-base /home/pat/drone/senior_project/ros/quadrotor/build/vision_opencv/cv_bridge \
    build --build-base "/home/pat/drone/senior_project/ros/quadrotor/build/vision_opencv/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
