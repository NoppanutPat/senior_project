...
echo_and_run cd "/home/pat/drone/senior_project/ros/quadrotor/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/pat/drone/senior_project/ros/quadrotor/src/vision_opencv/image_geometry/setup.py" \
    egg_info --egg-base /home/pat/drone/senior_project/ros/quadrotor/build/vision_opencv/image_geometry \
    build --build-base "/home/pat/drone/senior_project/ros/quadrotor/build/vision_opencv/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
