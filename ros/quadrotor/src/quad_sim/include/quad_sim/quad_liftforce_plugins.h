...
/// @{
/** \defgroup Quad_forcelift Plugin XML Reference and Example
...
class Quad_forcelift : public ModelPlugin
{
  /// \brief Constructor
  public: Quad_forcelift();

  /// \brief Destructor
  public: virtual ~Quad_forcelift();
  ...
  private: std_msgs::Float64MultiArray rotorvelo;
  private: std_msgs::Float64MultiArray liftforce;
