...
model = TD3(MlpPolicy, env, action_noise=action_noise, verbose=1, tensorboard_log="/home/pat/drone/senior_project/ros/quadrotor/src/quad_sim/log/tensorboard",learning_rate=0.001)
